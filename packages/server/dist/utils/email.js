...
export async function sendPasswordResetEmail(id, email, plainToken) {
    ...
    const body = mailTemplate("We have received a request to reset your password. Please reset your password using the link below.", `${baseLink}?userId=${id}&token=${plainToken}`, "Reset Password");
    const mailOptions = {
        email,
