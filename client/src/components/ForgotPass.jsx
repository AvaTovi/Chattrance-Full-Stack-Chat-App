      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="flex flex-col items-center justify-center text-center font-mono p-20 gap-8 bg-white rounded-2xl">
            ...
            <div className="flex flex-col text-2xl text-left gap-1">
              <span>Email</span>
              <input type="text" className="rounded-md p-1 border-2 outline-none text-black focus:border-blue-400 focus:bg-slate-500" />
              <button className="bg-blue-500 hover:bg-blue-700 mt-3 text-white rounded px-4 py-2">Reset Password</button>
            </div>
        </div>
      </section>
    </div>
